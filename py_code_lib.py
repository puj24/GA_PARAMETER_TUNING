...
# Calculate the fitness based on the differences between desired and obtained coordinates
    ...
    # Calculate the fitness based on the differences between desired and obtained coordinates
    fitness = numpy.sum(numpy.linalg.norm(desired_outputs - output_coordinates))
...
mutation_rate = [initial_mutation_percent, final_mutation_percent]
